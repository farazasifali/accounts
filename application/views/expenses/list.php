<div class="panel-heading">
    <div class="row">
        ...
        <div class="col-sm-6 text-right">
            <a href="<?= site_url("Expenses/add"); ?>" class="btn btn-primary">
...
<div class="panel-body">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover text-center">
            ...
            <tbody>
                <form id="deleteForm" method="post" action="<?= site_url('Expenses/delete'); ?>">
                    <?php if($records && is_array($records)){ ?>
                        <?php for ($i = 0; $i < count($records); $i++){ ?>
                            <tr>
                                ...
                                <td><?= $i + 1 ?></td>
                                <td><?= $this->expenses_category_model->getName($records[$i]->exp_cat_id); ?></td>
                                <td><?= $this->person_model->getName($records[$i]->person_id); ?></td>
